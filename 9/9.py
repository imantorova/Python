...
class Animal(Meta_Animal):
    def __str__(self):
        return 'метод __str__:  пробежала {} метров, говорит {}, за день раз {}, производит {}, количество в день {}'.format( self.dist, self.voice, self.voice_use, self.usefulness, self.usefulness_proz )

    def __repr__(self):
        return 'метод __repr__:  пробежала {} метров, говорит {}, за день раз {}, производит {}, количество в день {}'.format( self.dist, self.voice, self.voice_use, self.usefulness, self.usefulness_proz )
